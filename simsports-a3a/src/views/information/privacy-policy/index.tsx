	...
	const [privacyPolicyData] = useState<any[]>([
		{
			...
			text: [
				...
				"1.4 Any questions, comments or complaints you may send via email to allstar3pointapex@gmail.com",
			],
		},
		{
		...
		},
		{
			...
			text: [
				...
				"3.4 Public blockchain provides transparency for transactions, and MP is not responsible for preventing or managing information broadcasted on the blockchain.",
			],
		},
		{
		...
		},
		{
			...
			text: [
				...
				"10.2 Contact us: allstar3pointapex@gmail.com",
			],
		},
	]);
