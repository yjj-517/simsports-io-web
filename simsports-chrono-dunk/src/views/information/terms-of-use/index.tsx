...
const View: React.FC = () => {
	const [termsOfUseData] = useState<any[]>([
		...
		},
		{
			...
			text: [
				...
				"You must promptly notify MP in accordance with MP's Terms of Use to prevent unauthorized use or access to your SimSports account, password or other security breach, please notify at newgranulegames@gmail.com.",
				...
				"You must notify MP immediately of any unauthorized use of or access to your account, password or other security breach at newgranulegames@gmail.com",
		...
		},
		{
			...
			text: [
				...
				"17.5. Communication. Users who have issues, complaints, or claims about the website or game can email us via newgranulegames@gmail.com. Or contact us with the relevant contact information listed in.",
			],
		},
	]);
	...
	return (
		<section className="main py-20">
			{/* title */}
			<h1 className="text-5xl font-bold my-9">Acceptance of Terms</h1>
