			...
			<div class="market_box_right">
				...
				<div class="right_title">
					...
					<div class="right_shop">
						...
						<!-- <div>下拉框</div> -->
						<!-- 购物车 -->
						<div class="shopicon_box" @click.stop="dialog.state = true">
							<el-image :src="shopIcon" class="shopIcon" />
						</div>
					</div>
				</div>
				<!-- 图片展示 -->
				<div class="nftlist_box">
					<NftFigure v-for="(item, index) in nftList" :key="index" :nft-list="item" @click.stop="goAssets"></NftFigure>
				</div>
			</div>
		</div>
	</div>
	<shopdialogView :dialog="dialog"></shopdialogView>
</template>

<script setup lang="ts">
import { reactive, watchEffect } from "vue";
import shopIcon from "@/assets/imgs/nft/shopIcon.png"; //购物车
...
import NftFigure from "@/components/NftFigure/index.vue"; //筛选框
import shopdialogView from "./shopdialog.vue"; //购物车弹窗
