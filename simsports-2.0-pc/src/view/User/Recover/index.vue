...
<template>
	<div class="recover_box">
		<p class="login_box_title">Reset Password</p>
		<el-form ref="userRef" :model="user" :rules="userRules">
			<div class="box_text">
				...
				>
					<div id="login_input">
						<el-input v-model="user.new_password" placeholder="Enter New Password" show-password clearable />
					</div>
				</el-form-item>
				<div class="box_text_input">
		...
		<button class="login_box_input" @click.stop="onLogon(userRef)">Confirm</button>
...
import { postEmail, putPwd } from "@/http/api"; //接口
...
const validatePass2 = (rule: any, value: any, callback: any) => {
	...
	} else if (value !== user.new_password) {
...
const userRules = reactive<FormRules>({
	...
	new_password: [{ required: true, message: "Please enter a valid password", trigger: "blur" }],
